<form action="<?= base_url('menu-backend-add'); ?>" method="post">
   <div class="row">
      ...
      <div class="col-md-12 grid-margin stretch-card">
         <div class="card">
            <div class="card-body">
               <h6 class="card-title">Thông tin Menu</h6>
               <div class="mb-3">
                  <label class="form-label">Icon Font Awesome(<span>Menu con không cần Icon</span>)</label>
                  <input type="text" class="form-control" name="icon_font">
               </div>
               <div class="mb-3">
               ...
               <div class="mb-3">
                  ...
                  <select class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" name="menu_function">
                     <option value="0">Menu hiển thị</option>
                     <option value="1">Menu chức năng</option>
                  </select>
               </div>
               <div class="mb-3">
