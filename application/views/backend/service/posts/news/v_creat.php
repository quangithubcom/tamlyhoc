...
<form action="<?= base_url('news-add?category_type='.$category_type.'&type_template='.$type_template.'&lang='.$lang); ?>" method="post">
   <div class="row mt-3">
            ...
            <div class="card-body">
               ...
               <div class="row">
                  ...
                  <div class="col-md-6">
                     ...
                     <input type="datetime-local" class="form-control" name="date_creat" value="<?= date('Y-m-d H:i:s'); ?>">
                  </div>
               </div>
               ...
               <div class="col-md-12 mb-3">
                  ...
                  <div id="test">
                     <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="post_category_id[]" value="1" id="formCheck1" checked="">
            ...
            <div class="card-body">
               ...
               <div class="mb-3">
                  ...
                  <select  class="select2 form-control mb-3 custom-select" style="width: 100%; height:36px;" name="id_template" required>
                     <option value="0">Không có giao diện</option>
